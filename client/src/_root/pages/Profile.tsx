...
import { useGetUserById } from "@/lib/react-query/userQueries";
import { useGetUserPosts } from "@/lib/react-query/postQueries";
...
const Profile = () => {
  ...
  const { data: userPosts } = useGetUserPosts(currentUser?._id);
